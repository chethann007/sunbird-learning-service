...
public class SystemConfigUtilTest {
    ...
    public void initSuccess(){
        ...
        Mockito.when(HttpClientUtil.get(Mockito.anyString(), Mockito.anyMap(), (org.sunbird.request.RequestContext) Mockito.any())).thenReturn(getSystemConfigResponse());
        Mockito.when(HttpClientUtil.post(Mockito.anyString(), Mockito.anyString(), Mockito.anyMap(), (org.sunbird.request.RequestContext) Mockito.any())).thenReturn(getCustodianOrgResponse());
