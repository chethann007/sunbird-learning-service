...
public class OnRequestHandler implements ActionCreator {
    ...
    private static Map<String, Object> cacheTelemetryPdata() {
        ...
        telemetryPdata.put("telemetry_pdata_id", PropertiesCache.getInstance().getProperty("telemetry_pdata_id"));
        telemetryPdata.put(
                "telemetry_pdata_pid", PropertiesCache.getInstance().getProperty("telemetry_pdata_pid"));
        telemetryPdata.put(
                "telemetry_pdata_ver", PropertiesCache.getInstance().getProperty("telemetry_pdata_ver"));
